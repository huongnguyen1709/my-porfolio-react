...
const About = () => {
    ...
    return (
        <div className='about'>
            ...
            I have a passion in coding, building websites & applications. I am self-motivation and optimistic that promote myself to overcome the problem without
giving up. I am curious and constantly learning to keep myself updated. My hobbies are reading, traveling, and communicating with people. <br></br>
            <br></br>  
